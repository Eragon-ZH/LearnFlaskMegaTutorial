...
def search():
    ...
    posts, total = Post.search(g.search_form.q.data, page,
                               current_app.config['POSTS_PRE_PAGE'])
    next_url = url_for('main.index', q=g.search_form.q.data, page=page+1) \
        if total > page * current_app.config['POSTS_PRE_PAGE'] else None
